...
namespace DroneWebApp.Controllers.Tests
{
    ...
    public class FilesControllerTests
    {
        ...
        public void IndexTest2_ActionExecutes_ReturnsViewForIndex()
        {
            ...
            var result = controller.Index(3, postedFiles) as ViewResult;
        ...
        public void GetTotalFiles()
        {
            ...
            int totalFiles = controller.GetTotalFiles();
        ...
        [TestMethod()]
        public void GetResultAndFileNameTest()
        {
            // Create mock context
            Mock<DroneDBEntities> mockContext = new Mock<DroneDBEntities>();
            FilesController controller = new FilesController(mockContext.Object);
            ...
            var result = controller.GetResultsAndFileNames();
